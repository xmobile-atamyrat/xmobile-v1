...
async function backfillSlugs() {
    ...
    console.log(`✅ ${categoriesUpdated} Categories successfully updated with unique slugs.\n`);
    // 2. Process Products
    ...
    console.log(`✅ ${productsUpdated} Products successfully updated with unique slugs.\n`);
    console.log('🎉 Database backfill complete! All your products and categories now have permanent, unique SEO slugs.');
