export const productCardClasses = {
  card: {
    web: 'w-[240px] min-h-[320px] rounded-2xl overflow-hidden border border-[#F0EFF4] shadow-[0_6px_20px_rgba(20,16,60,0.05)] hover:shadow-[0_10px_28px_rgba(20,16,60,0.10)] transition-shadow duration-200 mx-[8px] my-[12px] bg-white',
    mobile:
  ...
  boxes: {
    ...
    detail: {
      web: 'flex flex-col justify-start px-[14px] pt-3 pb-[14px]',
      mobile: 'flex flex-col justify-start px-3 pt-[11px] pb-[13px]',
    },
    img: {
      web: 'relative flex justify-center h-[150px] bg-[#F5F5F8] items-center overflow-hidden',
      mobile:
        'relative flex w-full h-[128px] bg-[#F5F5F8] justify-center items-center overflow-hidden',
    },
  },
  brand: {
    web: 'text-[11px] font-semibold text-[#8B8A98]',
    mobile: 'text-[10px] font-semibold text-[#8B8A98]',
  },
  typo: {
    web: 'text-[14px] font-semibold leading-[1.3] text-[#17161D] mt-[3px] mb-2 line-clamp-2',
    mobile:
      'text-[13px] font-semibold leading-[1.3] text-[#17161D] mt-[2px] mb-[7px] line-clamp-2',
  },
  typo2: {
    web: 'font-bold text-[16px] leading-none text-[#20166E]',
    mobile: 'font-bold text-[15px] leading-none text-[#20166E]',
  },
  priceUnit: {
