export const signinClasses = {
  boxes: {
    ...
    categories: 'flex flex-col gap-1',
  ...
  paperSignup: {
    web: 'flex flex-col w-[400px] h-[500px] rounded-[16px] p-2 gap-2',
    mobile: 'flex flex-col w-[90%] h-[450px] rounded-[16px] p-2 gap-1',
  },
  buttonSubmit: {
  ...
  buttonRedirect: {
    web: 'normal-case px-2 text-[#000] font-bold',
    mobile: 'normal-case px-0 text-[#000] font-bold',
  },
  typo: {
